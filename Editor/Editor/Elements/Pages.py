...
from Editor.Editor.Elements.Tabs.Assets import AssetsTab
...
class ProjectPage(QMainWindow):
    def GetWindowSize():
        result = subprocess.run(['python', '-m', 'Editor.Editor.Configs', '--GetWindowSize'],
    ...
    def __init__(self, projectPath):
        ...
        def setMenuBar():
            ...
            runAction = fileMenu.addAction("&Run")
            def runCommand():
                command = "g++ Projects/dvd_bouncer/main.cpp Engine/render.cpp Engine/math.cpp Engine/game.cpp -o main -lGL -lGLU -lglut -ldl -lm -lglfw -lGLEW -lXi -lXmu && ./main && rm main"
            ...
            runAction.triggered.connect(runCommand)  # Connect the action
...
class NoProjectPage(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setStyleSheet(Path("Editor/Editor/styles/noProjectWindow.css").read_text())
    ...
    def OpenProject(self):
        ...
        result = subprocess.run(['python', '-m', 'Editor.Editor.FileManager',
        ...
        for line in result.stdout.splitlines():
            if line.startswith("isValidProject: "):
                ...
                if not isValid:
                    ...
                    subprocess.Popen(['python', '-m', 'Editor.Editor',
    ...
    def CreateProject(self):
        ...
        inputDialog.setWindowIcon(QIcon('Editor/Editor/icons/box-label.png'))
        inputDialog.setStyleSheet(Path("Editor/Editor/styles/createProjWindow.css").read_text())
        ...
        browseAction.setIcon(QIcon("Editor/Editor/icons/blue-document-search-result.png"))
