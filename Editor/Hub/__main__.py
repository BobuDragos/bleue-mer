...
from Editor.Hub.Elements.Tabs import LocalTab
...
if args.command == "SetWindowSize":
    ...
    print(Fore.YELLOW + "Instantiating " + "Editor.Hub.Configs" + " to get Hub window size...")
    result = subprocess.run(['python', '-m', 'Editor.Hub.Configs', '--GetWindowSize'], capture_output=True, text=True)
