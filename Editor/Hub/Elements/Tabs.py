...
from Editor.Hub.Elements.Tables import ProjectTable
...
class LocalTab(QWidget):
    ...
    def open_project(self):
        ...
        print(Fore.BLUE + "Calling " + "Editor.Hub.Configs --AddExistingProject" + " to open project...")
    ...
    def new_project(self):
        ...
        browseAction.setIcon(QIcon("Editor/Hub/icons/blue-document-search-result.png"))
        ...
        def createProject():
            ...
            print(Fore.BLUE + "Calling " + "Editor.Hub.Configs AddNewProject --name --path" + " to add new project...")
            result = subprocess.run(['python', '-m', 'Editor.Hub.Configs',
